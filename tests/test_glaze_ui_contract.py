...
class GlazeUiContractTests(SimpleTestCase):
    ...
    def test_glaze_documentation_preserves_v13_source_and_current_stable_boundary(self):
        ...
        self.assertIn("GLAZE UI V1.5 / `1.5.1`", doc)
        self.assertIn("5b59d0e36950d737dba35b58ae58058684e0831b", doc)
        self.assertIn("`applicable-migration-required`", doc)
        self.assertNotIn("Manager targets **Glaze UI 1.3.0 Stable**", doc)
        self.assertIn('glaze_ui_required: "1.5.1"', manifest)
        self.assertIn('glaze-ui==1.5.1', manifest)
